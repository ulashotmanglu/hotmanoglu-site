...
title: "Hakkında"
layout: "hakkinda"
description: "HOTMANOGLU'nun ne olduğu, nasıl hazırlandığı ve hangi editoryal ilkelerle çalıştığı."
---
...
- **Vaka dosyaları.** Tek bir olayın anatomisi: şema nasıl kuruldu, hangi noktada görünür oldu, hangi kontrol devrede değildi.
- **Gündem ve analiz.** Düzenleyici kararları, denetim raporları ve piyasa gelişmelerinin bağlamına oturtulmuş değerlendirmesi.
- **Kişisel yazılar.** Denetim, fraud, kariyer ve değişen iş dünyası üzerine, Ulaş Hotmanoğlu'nun kendi kaleminden metinler.

Amaç haber vermek değil, okuduktan sonra benzer bir olaya bakarken neye dikkat edileceğini bilmek.
...
- **Kaynak.** İddialar mümkün olduğunca birincil kaynağa dayandırılır; kaynak belirsizse bu metinde açıkça söylenir.
- **Doğrulama.** Sayısal veriler ve isimler yayın öncesi kontrol edilir.
- **Düzeltme.** Hata tespit edildiğinde içerik sessizce değiştirilmez; düzeltme görünür biçimde belirtilir. Bkz. [Düzeltme Politikası](/duzeltme-politikasi/).
- **Şeffaflık.** İçeriğin nasıl üretildiği gizlenmez.
- **Bağımsızlık.** Yazılar herhangi bir kurumun görüşünü temsil etmez; sponsorlu içerik yayımlanmaz.
- **İnsan onayı.** Yayımlanan her içerik bir insan tarafından okunmuştur.

Buradaki içerikler bilgilendirme amaçlıdır; hukuki, mali veya yatırım tavsiyesi değildir.
